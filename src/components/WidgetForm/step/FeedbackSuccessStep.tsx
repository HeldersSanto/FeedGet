...
export function FeedbacksuccessStep ({onSelectRestartButton}:FeedbacksuccessStepProps ){
    return(
        <>
            <header>
                <CloseButton />
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                type="button"
                className="py-2 px-4 mt-6 bg-zinc-800 rounded-[4px] border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-darkGray-500 focus:ring-roxo-300"
                >
                    Quero enviar outro 
                </button>
            </div>
